          ...
          <div style={styles.sidebarHeader}>
            <div style={styles.userInfo}>
              <div style={styles.avatar}>
                {users.name ? users.name.charAt(0).toUpperCase() : "?"}
              </div>
...
const styles = {
  ...
  height: "40px",
  borderRadius: "50%",
  background: "linear-gradient(135deg, #1e1b4b, #312e81)", // keep your gradient
  color: "#FFD700", // gold/yellow stands out on dark blue
  display: "flex",
  justifyContent: "center",
  alignItems: "center",
  fontWeight: "700",
  ...
  inputArea: {
    ...
    padding: "15px",
    gap: "10px",
    borderTop: "1px solid rgba(100, 40, 40, 0.1)",
  },
