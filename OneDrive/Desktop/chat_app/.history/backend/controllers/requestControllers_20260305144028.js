...
const { sendRequest, acceptRequest, rejectRequest, getFriendRequests } = require("../controllers/requestControllers");
const protect = require("../middlewares/auth");
const { sendMessage } = require("../controllers/messageControllers");
const { getFriends } = require("../controllers/friendsControllers");
const { getConversation } = require("../controllers/fetchconversationControllers");
...
router.get("/messages/:friendId", protect, getConversation);
...
module.exports = { sendRequest, acceptRequest, rejectRequest, getFriendRequests };